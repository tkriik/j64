 ...
 *   - unsigned 61-bit integers
 *   - signed 61-bit integers
...
#define J64_TAG_PRIM_UINT	0x1
#define J64_TAG_PRIM_INT	0x2
#define J64_TAG_PRIM_FLOAT	0x3
#define J64_TAG_PRIM_ISTR	0x4
#define J64_TAG_PRIM_BSTR	0x5
#define J64_TAG_PRIM_ARR	0x6
#define J64_TAG_PRIM_OBJ	0x7
...
struct j64_bstr_hdr {
	j64_uint_t len;
	j64_byte_t buf; /* only for addressing */
};
...
#define j64_uint(x)		J64_INIT(u, ((x) << J64_TAG_PRIM_SIZE) | J64_TAG_PRIM_UINT)
#define j64_int(x)		J64_INIT(i, ((x) << J64_TAG_PRIM_SIZE) | J64_TAG_PRIM_INT)
...
#define j64_is_uint(j)		(J64_GET_PRIM_TAG(j) == J64_TAG_PRIM_UINT)
#define j64_is_int(j)		(J64_GET_PRIM_TAG(j) == J64_TAG_PRIM_INT)
...
#define j64_get_uint(j)		((j).u >> J64_TAG_PRIM_SIZE)
#define j64_get_int(j)		((j).i >> J64_TAG_PRIM_SIZE)
